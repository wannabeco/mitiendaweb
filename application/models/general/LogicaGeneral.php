...
class LogicaGeneral  {
    ...
    public function insertaPedidoCliente($post)
    {
        ...
        if($contador == count($productosTemporal))
        {
            ...
            $mensaje  = "Hola, ha llegado un nuevo pedido de productos con la siguiente información<br><br>";

            $mensaje .= "<h2>DATOS DEL CLIENTE</h2>";
            $mensaje .= "Nombre: ".$informacionUsuario[0]['nombre']." ".$informacionUsuario[0]['apellido']."<br>";
            $mensaje .= "Teléfono: ".$informacionUsuario[0]['celular']."<br>";
            $mensaje .= "Dirección: ".$informacionUsuario[0]['direccion']."<br>";
